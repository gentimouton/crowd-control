...
from client.events_client import DownClickEvent, UpClickEvent, MoveMouseEvent, \
    ...
    MNameChangeFailEvt, MGameAdminEvt, ChangedMoveSpeedEvt
...
class ChatLogWidget(Widget):
    ...
    def __init__(self, evManager, numlines=3, rect=None):
        ...
        self._em.reg_cb(ChangedMoveSpeedEvt, self.on_movespeedchange)
    ...
    def on_movespeedchange(self, event):
        """ print in the widget that the speed was changed """
        
        linetxt = 'Now ' + event.move_txt
        self.addline(linetxt)
